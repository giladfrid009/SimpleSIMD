...
file struct AndNot_VSelector<T> : IFunc<Vector<T>, Vector<T>, Vector<T>> where T : struct, IBinaryNumber<T>
{
...
file struct AndNot_Selector<T> : IFunc<T, T, T> where T : struct, IBinaryNumber<T>
{
