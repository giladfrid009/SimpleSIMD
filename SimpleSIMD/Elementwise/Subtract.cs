...
file struct Subtract_VSelector<T> : IFunc<Vector<T>, Vector<T>, Vector<T>> where T : struct, INumber<T>
{
...
file struct Subtract_Selector<T> : IFunc<T, T, T> where T : struct, INumber<T>
{
